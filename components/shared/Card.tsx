...
const Card = ({
  ...
  return (
    <CardContainer
      ...
      className="size-full"
    >
      <CardBody className="group/card relative flex size-full flex-col gap-6 border-2 border-border bg-gray-100 p-6 hover:shadow-2xl dark:bg-black">
        <div className="flex h-full flex-col gap-4 overflow-hidden">
          <div className="flex flex-col gap-2">
            <h3 className="approach_title">
              {approach[type].title}
            </h3>
            <p className="approach_subtitle">
