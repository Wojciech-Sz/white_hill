...
const Appointment = () => {
  return (
    <section id="contact" className="appointment-section min-h-[60vh]">
      <div
        style={{
          backgroundImage:
            "url(https://utfs.io/f/e9343b39-5585-4828-a56e-c5b26f5fbc83-oe69nl.jpg)",
        }}
        className="fixed inset-0 -z-20 min-h-screen bg-[#9B9A99]/80 bg-cover bg-center bg-no-repeat bg-blend-multiply"
      />
